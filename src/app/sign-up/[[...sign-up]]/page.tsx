  ...
  return (
    <div className="h-screen flex items-center justify-between p-8">
      ...
      <div className="w-full lg:w-1/2 flex flex-col gap-4">
        <h1 className="text-2xl xs:text-4xl md:text-6xl font-bold">
          Happening Now
        </h1>
        ...
        <SignUp.Root>
            ...
            <div className="flex flex-col gap-4">
              ...
              <Clerk.Field name="username" className="flex flex-col gap-2">
                <Clerk.Input
                  ...
                  className="py-2 px-4 rounded-full text-black w-72 placeholder:text-sm"
                />
          ...
          <SignUp.Step name="verifications">
            <SignUp.Strategy name="email_code">
              ...
              <SignUp.Action
                submit
                className="mt-4 text-iconBlue underline text-sm"
              >
                Verify
              </SignUp.Action>
            </SignUp.Strategy>
